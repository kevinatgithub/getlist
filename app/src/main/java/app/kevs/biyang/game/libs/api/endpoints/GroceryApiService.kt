package app.kevs.biyang.game.libs.api.endpoints

import app.kevs.biyang.game.libs.api.CommonResult
import app.kevs.biyang.game.libs.api.GroceryApiResult
...
interface GroceryApiService {
    ...
    @POST("/save")
    @FormUrlEncoded
    fun uploadData(@Field("cards") cards : String,
                 @Field("ais") ais : String,
                 @Field("spells") spells : String) : Observable<CommonResult.Result>

    @GET("/dump")
    fun downloadData() : Observable<CommonResult.Enkanto>
}